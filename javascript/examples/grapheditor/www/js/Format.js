...
BaseFormatPanel.prototype.createColorOption = function(label, getColorFn, setColorFn, defaultColor, listener, callbackFn, hideCheckbox)
{
	...
	var apply = function(color, disableUpdate, forceUpdate)
	{
		...
		{
			applying = true;
            btn.innerHTML = '<div style="' + //P+Z: Removed width "width:' + ((mxClient.IS_QUIRKS) ? '30' : '36') + 'px';
				'height:12px;margin:3px;border:1px solid black;background-color:' +
    ...
    btn.style.width = '45px'; // P+Z: Set image color option button width
    // P+Z: Use custom button style
